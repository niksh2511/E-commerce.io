    ...
    <nav className="bg-gray-800 p-4 flex justify-between items-center">
      ...
      <div className="w-3/5">
        <input
            type="text"
            placeholder="Search"
            className="px-6 py-2 rounded-full bg-gray-500 outline-none text-white w-3/5 mx-auto"
            />
      </div>
      <div className="flex items-center space-x-4 ">
        
        <select className="p-2 rounded border-none row-start-1 col-start-1 bg-slate-50 dark:bg-slate-800 text-white">
